...
extern uint32_t _ssbl_lma, _ssbl, _essbl, _text_lma, _text, _etext, _rodata_lma, _rodata, _erodata, _data_lma, _data,  _edata, _bss, _ebss;
#define RTT
#ifdef RTT
extern uint32_t _data_extra,  _edata_extra , _data_extra_lma;
extern uint32_t _bss_extra,  _ebss_extra;
#endif
...
void __attribute((section(".fsbl")))_fsbl_init(void) {
	uint32_t *src = (uint32_t *)&_ssbl_lma;
