...
VL_INLINE_OPT void Vtop___024root___nba_sequent__TOP__0(Vtop___024root* vlSelf) {
    ...
    if (vlSelf->reset) {
        ...
        vlSelf->top__DOT__ifu_pc = 0x80000000U;
    } else {
        ...
        vlSelf->top__DOT__ifu_pc = vlSelf->top__DOT__ifu_t0__DOT__target_pc;
    }
    ...
    vlSelf->top__DOT__idu_t0__DOT____VdfgTmp_h5d003edb__0 
        = ((2U == (7U & (vlSelf->top__DOT__inst >> 0xcU)))
            ? 3U : ((3U == (7U & (vlSelf->top__DOT__inst 
                                  >> 0xcU))) ? 4U : 
                    ((7U == (7U & (vlSelf->top__DOT__inst 
                                   >> 0xcU))) ? 5U : 
                     ((6U == (7U & (vlSelf->top__DOT__inst 
                                    >> 0xcU))) ? 6U
                       : ((4U == (7U & (vlSelf->top__DOT__inst 
                                        >> 0xcU))) ? 7U
                           : ((1U == (7U & (vlSelf->top__DOT__inst 
                               ...
                               ? 8U : ((5U == (7U & 
                                        ...
                                        ? ((0U == (vlSelf->top__DOT__inst 
                                            ...
                                            ? 9U : 0xaU)
                                        : 0U)))))));
    vlSelf->top__DOT__lsu_cnt = ((0x23U == (0x7fU & vlSelf->top__DOT__inst))
                                 ...
                                 : ((0x6fU == (0x7fU 
                                     ...
                                     ? 7U : ((0x67U 
                                              == (0x7fU 
                                                  & vlSelf->top__DOT__inst))
                                              ? 8U : 0U)));
    vlSelf->top__DOT__rdata2 = ((0U == (0x1fU & (vlSelf->top__DOT__inst 
                                                 >> 0x14U)))
                                 ? 0U : vlSelf->top__DOT__mem_t0__DOT__rf
                                [(0x1fU & (vlSelf->top__DOT__inst 
                                           >> 0x14U))]);
    vlSelf->top__DOT__rdata1 = ((0U == (0x1fU & (vlSelf->top__DOT__inst 
                                                 >> 0xfU)))
                                 ? 0U : vlSelf->top__DOT__mem_t0__DOT__rf
                                [(0x1fU & (vlSelf->top__DOT__inst 
                                           >> 0xfU))]);
    ...
    vlSelf->top__DOT__exu_t0__DOT__IType = ((0x67U 
                                            ...
                                            | ((3U 
                                               ...
                                               | (0x13U 
                                                  ...
                                                  (0x7fU 
                                                   & vlSelf->top__DOT__inst))));
    vlSelf->top__DOT__alu_cnt = ((0x33U == (0x7fU & vlSelf->top__DOT__inst))
                                  ? ((0U == (7U & (vlSelf->top__DOT__inst 
                                                   >> 0xcU)))
                                      ? ((0U == (vlSelf->top__DOT__inst 
                                                 >> 0x19U))
                                  ...
                                  : ((0x13U == (0x7fU 
                                      ...
                                      : ((0x67U == 
                                          ...
                                          ? 1U : ((0x6fU 
                                                   ...
                                                   ? 1U
                                                   : 0U))));
    vlSelf->top__DOT__ifu_t0__DOT__jal = (IData)((7U 
                                                  == 
                                                  (7U 
    ...
    vlSelf->top__DOT__ifu_t0__DOT____VdfgTmp_hbd6b7a64__0 
        = (vlSelf->top__DOT__imm + vlSelf->top__DOT__ifu_pc);
    vlSelf->top__DOT__addr_load = (vlSelf->top__DOT__imm 
                                   + vlSelf->top__DOT__rdata1);
    vlSelf->top__DOT__exu_t0__DOT____VdfgTmp_h194da086__0 
        = (((IData)(vlSelf->top__DOT__exu_t0__DOT__UType) 
            | ((0x6fU == (0x7fU & vlSelf->top__DOT__inst)) 
               | (IData)(vlSelf->top__DOT__exu_t0__DOT__IType)))
            ? vlSelf->top__DOT__imm : (((0x33U == (0x7fU 
                                                   & vlSelf->top__DOT__inst)) 
                                        | ((0x23U == 
                                            (0x7fU 
                                             & vlSelf->top__DOT__inst)) 
    ...
    if ((8U & (IData)(vlSelf->top__DOT__lsu_cnt))) {
        if ((4U & (IData)(vlSelf->top__DOT__lsu_cnt))) {
            vlSelf->top__DOT__lsu_t0__DOT__temp = 0U;
        } else if ((2U & (IData)(vlSelf->top__DOT__lsu_cnt))) {
            vlSelf->top__DOT__lsu_t0__DOT__temp = 0U;
        } else if ((1U & (IData)(vlSelf->top__DOT__lsu_cnt))) {
            vlSelf->top__DOT__lsu_t0__DOT__temp = 0U;
        } else {
            Vtop___024unit____Vdpiimwrap_pmem_read_TOP____024unit(vlSelf->top__DOT__addr_load, 2U, vlSelf->__Vfunc_pmem_read__2__Vfuncout);
            vlSelf->top__DOT__lsu_t0__DOT__temp = vlSelf->__Vfunc_pmem_read__2__Vfuncout;
        }
    } else if ((4U & (IData)(vlSelf->top__DOT__lsu_cnt))) {
        if ((2U & (IData)(vlSelf->top__DOT__lsu_cnt))) {
            if ((1U & (IData)(vlSelf->top__DOT__lsu_cnt))) {
                Vtop___024unit____Vdpiimwrap_pmem_read_TOP____024unit(vlSelf->top__DOT__addr_load, 1U, vlSelf->__Vfunc_pmem_read__3__Vfuncout);
                vlSelf->top__DOT__lsu_t0__DOT__temp 
                    = vlSelf->__Vfunc_pmem_read__3__Vfuncout;
            } else {
                Vtop___024unit____Vdpiimwrap_pmem_read_TOP____024unit(vlSelf->top__DOT__addr_load, 4U, vlSelf->__Vfunc_pmem_read__4__Vfuncout);
                vlSelf->top__DOT__lsu_t0__DOT__temp 
                    = vlSelf->__Vfunc_pmem_read__4__Vfuncout;
            }
        } else if ((1U & (IData)(vlSelf->top__DOT__lsu_cnt))) {
            Vtop___024unit____Vdpiimwrap_pmem_read_TOP____024unit(vlSelf->top__DOT__addr_load, 2U, vlSelf->__Vfunc_pmem_read__5__Vfuncout);
            vlSelf->top__DOT__lsu_t0__DOT__temp = vlSelf->__Vfunc_pmem_read__5__Vfuncout;
        } else {
            Vtop___024unit____Vdpiimwrap_pmem_read_TOP____024unit(vlSelf->top__DOT__addr_load, 1U, vlSelf->__Vfunc_pmem_read__6__Vfuncout);
            vlSelf->top__DOT__lsu_t0__DOT__temp = vlSelf->__Vfunc_pmem_read__6__Vfuncout;
        }
    } else if ((2U & (IData)(vlSelf->top__DOT__lsu_cnt))) {
        if ((1U & (IData)(vlSelf->top__DOT__lsu_cnt))) {
    ...
    if ((0x6fU == (0x7fU & vlSelf->top__DOT__inst))) {
        vlSelf->top__DOT__exu_t0__DOT____VdfgTmp_he33d4997__0 = 4U;
        vlSelf->top__DOT__exu_t0__DOT__alu_b = 4U;
    } else {
        vlSelf->top__DOT__exu_t0__DOT____VdfgTmp_he33d4997__0 
            = (0x1fU & vlSelf->top__DOT__exu_t0__DOT____VdfgTmp_h194da086__0);
        vlSelf->top__DOT__exu_t0__DOT__alu_b = vlSelf->top__DOT__exu_t0__DOT____VdfgTmp_h194da086__0;
    }
    vlSelf->top__DOT__exu_t0__DOT____VdfgTmp_h72228fe7__0 
        = (vlSelf->top__DOT__exu_t0__DOT__alu_a >> (IData)(vlSelf->top__DOT__exu_t0__DOT____VdfgTmp_he33d4997__0));
    vlSelf->top__DOT__exu_t0__DOT____VdfgTmp_h800671aa__0 
        = VL_LTS_III(32, vlSelf->top__DOT__exu_t0__DOT__alu_a, vlSelf->top__DOT__exu_t0__DOT__alu_b);
    vlSelf->top__DOT__exu_t0__DOT____VdfgTmp_h8052707d__0 
        = (vlSelf->top__DOT__exu_t0__DOT__alu_a < vlSelf->top__DOT__exu_t0__DOT__alu_b);
    vlSelf->top__DOT__ifu_t0__DOT__target_pc = ((((~ 
                                                   (((IData)(vlSelf->top__DOT__pc_cnt) 
                                                     >> 3U) 
