...
void VMuxKey___024root___configure_coverage(VMuxKey___024root* vlSelf, bool first);

void VMuxKey___024root::__Vconfigure(bool first) {
    if (false && first) {}  // Prevent unused
    VMuxKey___024root___configure_coverage(this, first);
}
...
// Coverage
void VMuxKey___024root::__vlCoverInsert(std::atomic<uint32_t>* countp, bool enable, const char* filenamep, int lineno, int column,
