...
VL_ATTR_COLD void VMuxKey___024root___configure_coverage(VMuxKey___024root* vlSelf, bool first) {
    if (false && vlSelf) {}  // Prevent unused
    VMuxKey__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    VMuxKey___024root___configure_coverage\n"); );
    // Body
