...
VL_INLINE_OPT void VMuxKey___024root____Vdpiimwrap_top__DOT__pmem_read_TOP(IData/*31:0*/ rs1, IData/*31:0*/ &pmem_read__Vfuncrtn) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    VMuxKey___024root____Vdpiimwrap_top__DOT__pmem_read_TOP\n"); );
    // Body
    int rs1__Vcvt;
...
VL_INLINE_OPT void VMuxKey___024root___nba_sequent__TOP__1(VMuxKey___024root* vlSelf) {
    ...
    if (vlSelf->rst) {
        ...
        VMuxKey___024root____Vdpiimwrap_top__DOT__pmem_read_TOP(vlSelf->top__DOT__rs1, __Vfunc_top__DOT__pmem_read__0__Vfuncout);
...
VL_INLINE_OPT void VMuxKey___024root___nba_comb__TOP__0(VMuxKey___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    VMuxKey__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    VMuxKey___024root___nba_comb__TOP__0\n"); );
    // Body
